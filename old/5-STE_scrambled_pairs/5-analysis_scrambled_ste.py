...
def main():
    ...
    # We have four pieces, so we do this per piece. The order is always the
    labels_arranged_a = []
    labels_arranged_b = []
    ...
    for n_trial in range(len(indices_labels_arranged_a)):
        ...
        grand_df.to_csv('/home/horozco/5-STE_scrambled_pairs/csv_scrambled_matrices/scrambled_' + pair_a + '_' + pair_b + '_' + freq_band_s + '_' + freq_band_t + '_' + str(delay) + '.csv')
