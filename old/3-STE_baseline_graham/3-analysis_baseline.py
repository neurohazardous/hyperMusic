...
def main():
    ...
    sub_a_base_s = signal.decimate(sub_a_base_s_env_power, 5, axis=1,
                                   zero_phase=True)
    ...
    sub_b_base_s = signal.decimate(sub_b_base_s_env_power, 5, axis=1,
                                   zero_phase=True)
    ...
    if freq_band_s == freq_band_t:
        ...
        sub_a_base_t = signal.decimate(sub_a_base_t_env_power, 5, axis=1,
                                       zero_phase=True)
        ...
        sub_b_base_t = signal.decimate(sub_b_base_t_env_power, 5, axis=1,
                                       zero_phase=True)
